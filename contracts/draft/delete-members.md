...
+ 409 LastCaseRoleHolderCannotBeRemoved  target is the only holder of a case role on a case not yet closed; appoint another holder first — carries `appointments`, each a CaseAppointment (put-case-appointments.md)
```
